...
## Others
- <code style="background-color:#1a73e8; color:#fff; padding:1px 1px; border-radius:4px; font-weight:500;">IEEE SMC Conference 2025</code> [QCSH: Quantization Controlled Semantic Hashing for Effective Similar Text Search](https://ieeexplore.ieee.org/document/11343235), Zihan Ye, **Zhitian Hou**, Ge Lin, Kun Zeng
